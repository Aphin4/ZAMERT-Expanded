...
public class Variable : Value
{
    ...
    public override object GetValue(FunctionArgument args)
    {
        ...
        switch (Math.Min(3, Math.Max(0, AccessLevel.GetValue(args, 0))))
        {
            ...
            case 2:
                return ZAMERT.AdvancedMERTools.Singleton.SchematicVariables[args.Function.OSchematic].TryGetValue(str, out value) ? value : null;
            case 3:
                return ZAMERT.AdvancedMERTools.Singleton.RoundVariable.TryGetValue(str, out value) ? value : null;
        }
        return null;
    }
}
...
public class VFunction : Value
{
    ...
    public override object GetValue(FunctionArgument args)
    {
        if (ZAMERT.AdvancedMERTools.Singleton.FunctionExecutors[args.Function.OSchematic].TryGetValue(FunctionName.GetValue(args, ""), out FunctionExecutor function))
